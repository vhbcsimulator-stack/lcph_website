          ...
          <div className="lg:col-span-2 bg-surface-container-lowest p-8 rounded-xl border border-outline-variant/20 shadow-sm space-y-6">
            ...
            {formSubmitted ? (
              <div className="p-6 bg-primary-container text-on-primary-container rounded-xl text-center space-y-2">
                ...
                <h3 className="font-headline-sm text-headline-sm font-bold">Application Submitted!</h3>
                <p className="font-body-sm text-body-sm opacity-90">Our Broker Network Relations desk will contact you with accreditation terms.</p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block font-label-lg text-label-lg text-on-surface-variant mb-1">Full Name / Agency</label>
                  ...
                  <div>
                    <label className="block font-label-lg text-label-lg text-on-surface-variant mb-1">PRC License / DHSUD Reg No.</label>
                ...
                <div>
                  <label className="block font-label-lg text-label-lg text-on-surface-variant mb-1">Partnership Category</label>
